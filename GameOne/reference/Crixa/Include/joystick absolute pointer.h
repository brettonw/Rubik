...
#ifndef	JOYSTICK_ABSOLUTE_POINTER
#define	JOYSTICK_ABSOLUTE_POINTER
...
//------------------------------------------------------------------------------
class JoystickAPointer : public PointerDevice																		//	joystick input class
{																																								//	begin
	...
	public:																																				//	members available externally
				JoystickAPointer (JoystickDevice *dev, Real filter);										//	constructor
virtual	~JoystickAPointer (void);																								//	destructor
virtual	Bool						Update (int count);																			//	update the pointer status
virtual	Vector_2d				GetPos (void);																					//	get the pointer position
				void						SetAxis (int axis);																			//	set the axis to check on the joystick
};																																							//	end

//------------------------------------------------------------------------------

#endif	//	JOYSTICK_ABSOLUTE_POINTER